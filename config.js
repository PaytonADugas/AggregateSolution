exports.creds = {
  // Required
  identityMetadata: 'https://login.microsoftonline.com/rapidteksolutionscom.onmicrosoft.com/v2.0/.well-known/openid-configuration', 
  ...
  clientID: '00b07b4c-095e-4c14-8a83-951b18adad7d',

  // Required if `responseType` is 'code', 'id_token code' or 'code id_token'. 
  // If app key contains '\', replace it with '\\'.
  clientSecret: '9L-28zH.5GI.XuCXL1Wr~wq7Kqq4RH7E4', 
...
exports.destroySessionUrl = 'https://login.microsoftonline.com/common/oauth2/logout?post_logout_redirect_uri=https://localhost:3000';
